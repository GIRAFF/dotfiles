...
syn keyword lispFunc		otherwise				user-homedir-pathname
...
" dasha keywords
syn keyword lispDecl options lib nodes coords digressions
syn keyword lispDecl non-ignored on-enter on-exit
syn keyword lispDecl transitions priority repeat-mode digression-override

" conditions
syn keyword lispKey and or not defined func eq gte gt speech fact sentiment once timeout-trigger input always

" reactions
syn keyword lispFunc say cond set switch revert eval none repeat continue pop push timeout append + repeater

" common keywords
syn keyword lispAtom root dial hangup dig:root
syn keyword lispAtom open-session-channel finished-playing-audio-channel speech-to-text-info
syn keyword lispAtom timeout-tick close-session-channel recognized-speech
syn keyword lispAtom input-info type
syn keyword lispAtom restart stop remove reset pause start edit all
" func and message are both reactions and conditions
syn keyword lispAtom func message ignore override complement first short
